...
public class StudentAdapter extends ArrayAdapter <Student>{
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder.tvStudentName = convertView.findViewById(R.id.tv_StudentName);
            holder.tvStudentID = convertView.findViewById(R.id.tv_StudentID);
            holder.tvStudentCourse = convertView.findViewById(R.id.tv_StudentCourse);
